def meningbearb(mening): #Bearbetar meningen och tar bort skiljetecken
    ...
    bemening6=bemening6.lower() #Gör meningen till små bokstäver
    return(bemening6.rstrip()) #rstrip tar bort mellanslag i slutet av meningen för att inte skap tomma objekt
